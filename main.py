...
from schemas import UserModel, UserCreateModel, TokenData, UserInDB, UserSchema, Token
...
async def login_for_access_token(form_data:OAuth2PasswordRequestForm = Depends()):
    ...
    access_token = await db.create_access_token(data={'sub':user.username}, expires_delta=access_token_expires)
